...
class Monsters extends engine.DisplayObjectContainer {
    ...
    constructor(monsters: Monster[], taskNumberString: string) {
        ...
        this.addButton.addEventListener(engine.TouchEventsType.TOUCH_TAP, this.onClickAdd, this);
        this.subButton.addEventListener(engine.TouchEventsType.TOUCH_TAP, this.onClickSub, this);
